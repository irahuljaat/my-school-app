            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                >
                    <div className="flex flex-col items-center space-y-3">
                        ...
                        <div 
                            className="w-24 h-32 rounded-2xl bg-slate-50 border-2 border-dashed border-slate-200 flex flex-col items-center justify-center overflow-hidden relative group transition-all shadow-inner"
                        >
                            {formData.imageUrl ? (
