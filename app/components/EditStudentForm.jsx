...
import { useColors } from './ColorComponent'; // Imported from ColorComponent
...
export default function EditStudentForm({ studentData, onClose, onStudentUpdated, activeSession }) {
    const colors = useColors(); // Consume colors from ColorComponent context
    ...
    const [formData, setFormData] = useState({
        ...
        aadhaarNumber: studentData.aadhaarNumber || '', // [Aadhaar Redacted]
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        >
                            <div className="flex flex-col items-center space-y-3">
                                <div className="w-28 h-28 rounded-2xl bg-slate-50 border-2 border-dashed border-slate-200 flex items-center justify-center overflow-hidden relative group transition-all shadow-inner">
                                    {formData.imageUrl ? (
